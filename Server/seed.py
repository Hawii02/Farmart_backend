...
def seed_data():
    with app.app_context():
        ...
        animals = [
            Animal(type='chicken', breed='Rhode Island Red', price=1100, status='Available',
            ...
            Animal(type='geese', breed='African', price=2500, status='Available',
                   ...
                   farmer_id=farmer_id, category_id=category_mapping['Poultry']),
            Animal(type='duck', breed='Pekin', price=2800, status='Available',
                   description='snowy white',
                   image_url='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuz3BTtTgC-rpg2EW9pzMKPeTg6SODZpBbsA&s',
                   farmer_id=farmer_id, category_id=category_mapping['Poultry']),
            ...
            Animal(type='horse', breed='friesian', price=1000000, status='Available',
                   ...
                   farmer_id=farmer_id, category_id=category_mapping['Equines']),
            Animal(type='camel', breed='Kharai', price=170000, status='Available',
            ...
            Animal(type='camel', breed='Targui', price=340000, status='Available',
                   ...
                   farmer_id=farmer_id, category_id=category_mapping['Camelids']),
            Animal(type='camel', breed='Dromedary', price=273000, status='Available',
            ...
            Animal(type='bee', breed='bumble', price=5100, status='Available',
                   ...
                   farmer_id=farmer_id, category_id=category_mapping['Apiary']),
            Animal(type='fish', breed='tilapia', price=1500, status='Available',
            ...
            Animal(type='fish', breed='mudfish', price=2950, status='Available',
            ...
            Animal(type='fish', breed='salmon', price=5000, status='Available',
                   ...
                   farmer_id=farmer_id, category_id=category_mapping['Aquatic']),
            Animal(type='ostriches', breed='common', price=150000, status='Available',
